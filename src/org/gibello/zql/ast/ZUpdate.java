...
public class ZUpdate implements ZStatement {
	 ...
	 *            update), and values are ZExp objects (the column values). For
	 ...
	 *         and values are ZExp objects (Expressions that specify column
	...
	public void addColumnUpdate(String col, ZExp val) {
		if (set_ == null)
			set_ = new Hashtable<String, ZExp>();
		set_.put(col, val);
		if (columns_ == null)
			columns_ = new Vector<String>();
