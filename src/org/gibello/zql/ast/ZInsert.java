 ...
 */
public class ZInsert implements ZStatement, Cloneable {
	 ...
	 *            list. If it is a SELECT statement, e should be a ZQuery
	 *            object.
	 */
	public void setValueSpec(ZExp e) {
		valueSpec_ = e;
	}
	 ...
	 * 
	 * @return A vector of SQL Expressions (ZExp objects); If there's no VALUES
    ...
    public ZInsert clone() throws CloneNotSupportedException {
        return (ZInsert) super.clone();
}
