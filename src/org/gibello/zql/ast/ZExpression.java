 ...
 */
public class ZExpression implements ZExp, Cloneable  {

	String op_ = null;
	Vector<ZExp> operands_ =  new Vector<ZExp>();
	...
	private boolean needPar(String op) {
		...
		return !(tmp.equals("ANY") || tmp.equals("ALL") || tmp.equals("UNION") || ZUtils
				.isAggregate(tmp));
	}
    ...
    public ZExpression clone() throws CloneNotSupportedException {
        return (ZExpression) super.clone();
    }
