package org.gibello.zql.parser;
/*
...
import org.gibello.zql.ast.ZStatement;
import org.gibello.zql.ast.ZUtils;
...
public class ZqlParser {
  ...
  private ZqlJJParser _parser = null;
  
  static private  ZqlParser instance = new ZqlParser();
  
  static public ZqlParser getInstance() {
	  return instance;
  }
   ...
   */
  private ZqlParser(InputStream in) {
    initParser(in);
  }
